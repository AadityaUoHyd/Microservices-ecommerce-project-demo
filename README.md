...
# VAULT : Open vault server from where its installed using cmd and type command.
...
# KEYCLOAK : Open keycloak server. Go to  =>  
...
# How Logstash, Elasticsearch and Kibana works : 
